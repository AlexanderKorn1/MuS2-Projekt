...
#os.makedirs("../Test1/kitchen", exist_ok=True)

#dataset = torchvision.datasets.ImageFolder("../Test1")
transform = transforms.Compose([transforms.Resize(opt.img_size), transforms.ToTensor(), transforms.Normalize([0.5], [0.5])])

dataset = datasets.ImageFolder('pics', transform=transform)
...
for epoch in range(opt.n_epochs):
    ...
    for i, (imgs, _) in enumerate(dataloader):
        ...
        #print("Shape real: %d, Shape fake: %d" % (real_imgs.shape, fake_imgs.shape))
        #print("Shape real:")
